...
void AScript()
{
    ...
    for (int wave = 1; wave < 21; ++wave)
    {
        ...
        {
            Connect(wave, -10, aCobManager.RoofFire({{2, 9}, {2, 9}, {4, 9}}); // -10 + 387 < 377
            ...
            if (wave == 9)
            {
                ...
                Connect(wave, 601 + 1200 - 200 - 387, aCobManager.RoofFire({{5, 9}, {5, 9}});
        ...
        else if (ARangeIn(wave, {2, 4, 6, 8, 11, 13, 15, 17, 19}))
        {
            ...
            Connect(wave, 1200 - 200 - 387, aCobManager.RoofFire({{2, 9}, {4, 9}}); // 1200cs 波长; 激活炸
            ...
            if (wave == 19)
            {
                ...
                Connect(wave, 1200 + 601 + 1200 - 200 - 387, // 等会儿
