...
void AScript()
{
    ...
    for (int wave = 1; wave < 21; ++wave)
    {
        ...
        else if (wave == 20)
        {
            ...
            Connect(wave, 517, aCobManager.Fire(2, 9));
            // 第 20 波手动收尾
        }
        ...
        else
        {
            ...
            Connect(
                wave, 360 - 298, if (wave != 2) { aIceFiller.Coffee(); } else { ACard(ACOFFEE_BEAN, 5, 5); }); // 360cs 反应冰
            Connect(
                wave, 360 + 500 - 373, if (wave != 2 && wave != 11) { aCobManager.Fire(5, 3); }); // 下半场尾炸
            ...
            if (wave == 9 || wave == 19) // 收尾波次
            {
                ...
                Connect(
                    wave, 4500 - 200 - 373, aCobManager.Fire(5, 5);
                    if (wave == 9) {
